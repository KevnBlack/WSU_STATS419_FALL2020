...
nonlinear growth curves; Richard's curve; simulated critical points \par
    ...
    \hbox{\vrule height .2pt width 39.14pc}
    \vskip 5pt 
    \hfill \textbf{\textcolor{WSU.gray}{ October 29, 2020 } }
    \vskip 5pt 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{path.project =}\StringTok{ "D:/School/Fall 2020/STAT 419/git/WSU_STATS419_FALL2020/PROJECT-01/"}\NormalTok{;}

\NormalTok{path.to.secret =}\StringTok{ "D:/School/Fall 2020/STAT 419/git/WSU_STATS419_FALL2020/WEEK-10/"}\NormalTok{;}
