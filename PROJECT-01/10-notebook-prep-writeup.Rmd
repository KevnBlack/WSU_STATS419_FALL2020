...
measure.m = measure[measure$gender == "male",]
measure.f = measure[measure$gender == "female",]

par(mfrow=c(1,2))
plot(measure.m$height.NA,measure.m$arm.span.NA,
     main=paste("Correlation =",round(cor(measure.m$height.NA,measure.m$arm.span.NA),5)),
     xlab="Male Height (in)",ylab="Male Arm Span (in)")

plot(measure.f$height.NA,measure.f$arm.span.NA,
     main=paste("Correlation =",round(cor(measure.f$height.NA,measure.f$arm.span.NA),5)),
     xlab="Female Height (in)",ylab="Female Arm Span (in)")
